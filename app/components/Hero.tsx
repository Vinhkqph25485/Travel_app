...
const Hero = () => {
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-10 pd-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        <div className="my-11 flex gap-5">
          ...
          <p className="bold-16 lg:bould-20 text-blue-70">
            198k
